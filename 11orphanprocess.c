/*To create an orphan process in c programming language, we need to fork a child process 
    from a parent process and then exit the parent process before 
    the child process has completed execution.*/
